...
class SearchViewHolder (view: View): RecyclerView.ViewHolder(view) {
    ...
    fun bind(user: UserHistoryResponse, onItemSelected: (UserHistoryResponse) -> Unit, onHistoryDeleteButtonClicked: (Long, Int) -> Unit) {
        ...
        binding.btnDeleteHistory.setOnClickListener { onHistoryDeleteButtonClicked(user.id?: -1, adapterPosition) }
